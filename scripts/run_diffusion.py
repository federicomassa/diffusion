...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--results-dir", type=str, default="/home/federico/results",
...
def main():
    ...
    try:
        ...
        sys.argv = [
            ...
            "--sigma", "0.1",
            "--time_steps", "100",  # More diffusion steps
            "--epochs", str(epochs),
            "--batch_size", "128",
            "--learning_rate", "1e-3",
        ...
        # Run the training
        print(f"Running diffusion model training with {n_samples} samples and {epochs} epochs...")
